...
6. 테스트에서 발견된 이슈들은 모두 조치해 주세요.
7. `ai-review` 스킬을 사용하여 코드 리뷰를 진행하세요.
8. 코드 리뷰의 결과를 확인하고 조치를 진행하세요.
9. 코드 리뷰를 조치한 후에는 lint, unit test를 다시 진행해야 합니다. (이슈 발견시 조치 필요)

## ISSUE FIX
lint, unit test, code review 등에서 보고되는 사항은 기존부터 발생하던 이슈라 할지라도 반드시 해결이 필요합니다.
